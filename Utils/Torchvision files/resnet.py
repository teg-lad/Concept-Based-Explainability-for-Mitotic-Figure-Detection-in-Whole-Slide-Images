...
class ResNet(nn.Module):
    ...
    def _forward_impl(self, x: Tensor, additional_values: [Tensor], decoder_output: bool) -> Tensor:
    ...
    def forward(self, x: Tensor, additional_values: [Tensor] = [None, None, None, None],
                decoder_output: bool = False) -> Tensor:
        return self._forward_impl(x, additional_values, decoder_output)
